...
echo:
echo                 [1] ANA HARAMI ABGHA ABOOG OFFICE
echo:
echo                 [2] ABGHA ATOOB - EMSAH AL-TAFEEL
echo                 ____________________________________________
echo:
echo                 [3] TANZEEL OFFICE ASLI
echo:
echo                 [0] EDGAT ASHAN TETLAA
echo         ____________________________________________________________
echo: 
call :dk_color2 %_White% "             " %_Green% "EKHTAR YA HARAMI [1,2,3,0]"
choice /C:1230 /N
set _el=!errorlevel!
if !_el!==4  exit /b
...
echo:
echo TAFTEESH WA SAHB MALOOMAT - AKHD AL-ASRAR WA NASHEER AL-FADAYEH..
call :dk_chkmal
...
call :dk_color %Green% "TAMAT AL-SERKA BE NAJAH YA HARAMI - AL-OFFICE SAR SHAGHAL 100/100."
...
echo:
echo KHALAS.. ASHANK TUBT BENAMSAH AL-FADAYEH !
echo:
...
echo KHALAS ENT TOOBT MEN ZAMAN.
) else (
if defined _unerror (
...
call :dk_color %Green% "TAMAT AL-TOOBA BE NAJAH - KHALAS AL-OFFICE SAR NADEEF."
)
)
echo __________________________________________________________________________________________
...
echo TAFTEESH WA SAHB MALOOMAT - AKHD AL-ASRAR WA NASHEER AL-FADAYEH..         [%winos% ^| %fullbuild% ^| %osarch%]
exit /b
...
if defined terminal (
call :dk_color %_Yellow% "EDGAT ASHAN TETLAA..."
choice /c 0 /n
) else (
call :dk_color %_Yellow% "EDGAT ASHAN TETLAA..."
pause >nul
